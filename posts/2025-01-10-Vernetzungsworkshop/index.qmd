...
Des Weiteren arbeiten wir derzeit an der Veröffentlichung der Ergebnisse der Bestandsaufnahme deutscher Wissenschaftsblogs. Wir werden die Veröffentlichung des Artikels über unsere [Mailingliste](infra-wiss-blogs@listserv.dfn.de) kommunizieren. Die Anmeldung zur Liste ist [hier](https://www.listserv.dfn.de/sympa/info/infra-wiss-blogs) möglich. Eine englische Version dieses Blogeintrags steht auf unserem Lehrstuhlblog verfügbar und kann [hier](https://doi.org/10.59350/4fc41-6n753) gefunden werden [@ochsner_research_2025].
